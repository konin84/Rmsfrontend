                ...
                <div className=" w-1/2 py-10 px-4 container mx-auto border border-gray-400 text-left rounded-lg md:w-full ">
                  ...
                  <div className=" text-xl mb-3 p-20 text-left">
                      {bill && (
                          ...
                          <p >Agent/Realtor &nbsp; &nbsp; &nbsp;&nbsp;:  {bill.Bill.realtor}</p>
                          <p >House reference &nbsp;: {bill.Bill.house}</p>
                          <p >Payment Method &nbsp;: {bill.Bill.paymentMethod}</p>
                          <p >Amount Paid &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:    {bill.Bill.amount}</p>
                          <p >Payment made of &nbsp;: {bill.Bill.tenant}</p>

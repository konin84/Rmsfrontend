...
export default function HouseOwnerList() {
  ...
  const handleDelete = (user) => {
    ...
    // Search variables
      ...
      const search = (user)=>((user.first_name + " " + user.last_name).toLowerCase().includes(query))||(user.email.toLowerCase().includes(query))||(user.phone_number.toLowerCase().includes(query))
